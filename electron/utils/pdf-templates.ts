 ...
 * These templates are embedded as strings to avoid file system dependencies
 */

export const PDF_LAYOUT_TEMPLATE = `<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title>QA Report - {{emailData.subject}}</title>
...
<body class="bg-white p-8 text-sm">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mt-8 pt-4 border-t border-gray-300 text-center text-gray-500 text-xs">
            <p>Generated by QAView on {{generatedAt}}</p>
        </div>
    </div>
</body>
</html>`;

export const PDF_REPORT_TEMPLATE = `<!-- Header -->
